...
/**
 * Classes extra test annotated with {@code @RunWith(Cucumber.class)} will run a Cucumber Feature. The class should be empty without any
 * fields or methods.
 * <p/>
 * Cucumber will look for a {@code .feature} file on the classpath, using the same resource path as the annotated class ({@code .class}
 * substituted by {@code .feature}).
 * <p/>
...
public class Cucumber extends ParentRunner<FeatureRunner> {
	...
	private final Class runningClazz;
	...
	protected Description describeChild(FeatureRunner child) {
		...
		returnValue.setClazz(runningClazz.getCanonicalName());
		return returnValue;
	}
	...
	/**
	 * This annotation can be used to give additional hints to the {@link cucumber.junit.Cucumber} runner about what to run. It provides
	 * similar options to the Cucumber command line used by {@link cucumber.cli.Main}
	 */
